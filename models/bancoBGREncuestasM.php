...
Class bancoBGREncuestasM {
    ...
    function selectAll() { //mostrar todos los registros
        $sql = "SELECT c.ID, c.CampaignId, c.ImportId, c.IDENTIFICACION, c.NOMBRE_CLIENTE, "
                . "c.AGENCIA, c.SECCION, c.FECHA_ATENCION, cc.LastAgent 'Agent', "
				. "CASE WHEN TIPO_TRANSACCION = '' THEN TRAMITES "
				. "ELSE TIPO_TRANSACCION END AS TIPO_TRANSACCION "
                . "FROM clientes c, cck.contactimportcontact cc  "
                . "where c.Id = cc.id and cc.LastAgent = '$_SESSION[usu]' and c.CampaignId = 'BGR_ENCUESTAS' "
