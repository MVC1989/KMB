...
//                . "where g.contactid = c.id and c.LastAgent = '$_SESSION[usu]'  "
...
//    }
    ...
    function selectAll() { //mostrar todos los registros
        $sql = "SELECT c.ID, c.CampaignId, c.ImportId, c.IDENTIFICACION, c.NOMBRE_CLIENTE, "
                ...
                . "FROM clientes c, cck.contactimportcontact cc  "
                . "where c.Id = cc.id and cc.LastAgent = '$_SESSION[usu]' "
                . "and cc.Lastupdate like '%CS-2020-237%' "
                . "and (cc.action = 'reciclar base' or cc.action = 'asignar base') and cc.action <> 'cancelar base' ";
        return ejecutarConsulta12($sql);
    }
    ...
    function selectAll_1() { //mostrar todos los registros
        $sql = "SELECT c.ID, c.CampaignId, c.ImportId, c.IDENTIFICACION, c.NOMBRE_CLIENTE, "
                . "c.EDAD, c.REGION, c.LOCALIDAD, cc.LastAgent 'Agent', c.ResultLevel2 "
                . "FROM clientes c, cck.contactimportcontact cc  "
                . "where c.Id = cc.id and cc.LastAgent = '$_SESSION[usu]' and cc.lastupdate = 'CS-2020-016_CLIENTES_POT_AHORRO_PROG' "
                . "and (cc.action = 'reciclar base' or cc.action = 'asignar base') and cc.action <> 'cancelar base' ";
        return ejecutarConsulta12($sql);
    }
    ...
    function selectAll_2() { //mostrar todos los registros
        $sql = "SELECT c.ID, c.CampaignId, c.ImportId, c.IDENTIFICACION, c.NOMBRE_CLIENTE, "
                . "c.EDAD, c.REGION, c.LOCALIDAD, cc.LastAgent 'Agent', c.ResultLevel2 "
                . "FROM clientes c, cck.contactimportcontact cc  "
                . "where c.Id = cc.id and cc.LastAgent = '$_SESSION[usu]' and cc.lastupdate = 'CS-2020-016_CLIENTES_ACT_AHORRO_NORMAL' "
                . "and (cc.action = 'reciclar base' or cc.action = 'asignar base') and cc.action <> 'cancelar base' ";
        return ejecutarConsulta12($sql);
    }
    ...
    function selectAll_3() { //mostrar todos los registros
        $sql = "SELECT c.ID, c.CampaignId, c.ImportId, c.IDENTIFICACION, c.NOMBRE_CLIENTE, "
                . "c.EDAD, c.REGION, c.LOCALIDAD, cc.LastAgent 'Agent', c.ResultLevel2 "
                . "FROM clientes c, cck.contactimportcontact cc  "
                . "where c.Id = cc.id and cc.LastAgent = '$_SESSION[usu]' and cc.lastupdate = 'CS-2020-016_CLIENTES_POT_AHORRO_NORMAL' "
                . "and (cc.action = 'reciclar base' or cc.action = 'asignar base') and cc.action <> 'cancelar base' ";
        return ejecutarConsulta12($sql);
    }
    ...
    function selectAll_4() { //mostrar todos los registros
		...
		. "where c.Id = cc.id and cc.LastAgent = '$_SESSION[usu]' and "
                . "(cc.lastupdate like '%CS-2020-061%' or cc.lastupdate like '%CS-2020-062%' or cc.lastupdate like '%CS-2020-063%')"
                . "and (cc.action = 'reciclar base' or cc.action = 'asignar base') and cc.action <> 'cancelar base' ";
        return ejecutarConsulta12($sql);
    }
    ...
    function selectAllRec_2() { //mostrar todos los registros //or cc.action = 'Reciclar Base'
        $sql = "SELECT g.ID, g.CampaignId, g.ImportId, g.IDENTIFICACION, g.NOMBRE_CLIENTE, "
                . "g.EDAD, g.REGION, g.LOCALIDAD, g.Agent 'Agent', g.ResultLevel2, g.managementresultcode "
                . "from gestionfinal g, cck.contactimportcontact c "
    ...
    function selectAllRec_3() { //mostrar todos los registros //or cc.action = 'Reciclar Base'
        $sql = "SELECT g.ID, g.CampaignId, g.ImportId, g.IDENTIFICACION, g.NOMBRE_CLIENTE, "
                . "g.EDAD, g.REGION, g.LOCALIDAD, g.Agent 'Agent', g.ResultLevel2, g.managementresultcode "
                . "from gestionfinal g, cck.contactimportcontact c "
