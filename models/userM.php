...
Class User {
    ...
    function insert($Id, $identificacion, $Name1, $Name2, $Surname1, $Surname2, $country, $city, $gender, $fecha, $Password, $adress, $celular, $telefono, $email, $state, $userId, $date, $userGroup) { //inserción de datos
        $sql = "INSERT INTO user(Id, VCC, Identification, Name1, Name2, Surname1, Surname2, Gender, Country, City, dateBirth, Password, Address, ContacAddress, ContacAddress1, Email, State, UserGroup, UserCreate, TmStmpCreate) VALUES "
                . "('$Id','1','$identificacion','$Name1','$Name2','$Surname1','$Surname2','$gender','$country','$city','$fecha','$Password','$adress','$celular','$telefono','$email','$state','$userGroup','$userId','$date')";
        return ejecutarConsulta($sql);
    }

    function update($Id, $identificacion, $Name1, $Name2, $Surname1, $Surname2, $country, $city, $gender, $fecha, $Password, $adress, $celular, $telefono, $email, $state, $userId, $date, $userGroup) { //actualización de datos
        $sql = "UPDATE user SET Identification='$identificacion',Name1='$Name1',Name2='$Name2',Surname1='$Surname1',Surname2='$Surname2', Gender='$gender',Country='$country',City='$city',dateBirth='$fecha',Password='$Password',Address='$adress',ContacAddress='$celular',ContacAddress1='$telefono',Email='$email',State='$state',UserGroup='$userGroup',UserShift='$userId',TmStmpShift='$date' WHERE Id = '$Id'";
        return ejecutarConsulta($sql);
    }
