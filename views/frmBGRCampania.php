                            ...
                            <div id="pnlEncuesta" class="col-xs-12 btn">
                                <div class="box box-widget bg-gray">
                                    <div class="box-body">
                                        ...
                                        <div class="col-xs-10"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="Califique del 1 al 7 siendo 1 malo y 7 excelente: El apoyo o guía recibida para buscar una solución a su requerimiento" readonly/></div>
                                        <div class="col-xs-2">
                                        ...
                                        <div class="col-xs-8">
                                            <input id="respuesta1_1" name="respuesta1_1" type="text" class="form-control">
                                        </div>
                                        <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                        ...
                                        <div class="col-xs-8">
                                            <input id="respuesta2_1" name="respuesta2_1" type="text" class="form-control">
                                        </div>
                                        <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                        ...
                                        <div class="col-xs-8">
                                            <input id="respuesta3_1" name="respuesta3_1" type="text" class="form-control">
                                        </div>
                                        <!---------------------------------------------------------PREGUNTA 4---------------------------------------------------->
                                        <div class="col-xs-12"><label>PILAR - SERVICIO / ATRIBUTO - Empatía</label></div>
                                        <div class="col-xs-10"><input id="pregunta4" name="pregunta4" class="text-bold form-control" value="Califique del 1 al 7 siendo 1 malo y 7 excelente: La preocupación del asesor por entender su necesidad" readonly/></div>
                                        <div class="col-xs-2">
                                        ...
                                        <div class="col-xs-8">
                                            <input id="respuesta4_1" name="respuesta4_1" type="text" class="form-control">
                                        </div>
                                        <!---------------------------------------------------------PREGUNTA 5---------------------------------------------------->
                                        ...
                                        <div class="col-xs-8">
                                            <input id="respuesta5_1" name="respuesta5_1" type="text" class="form-control">
                                        </div>
                                        <!---------------------------------------------------------PREGUNTA 6---------------------------------------------------->
                                        <div class="col-xs-12"><label id="pilar6">PILAR - PERSONALIZACIÓN / ATRIBUTO - Personalización</label></div>
                                        <div class="col-xs-10"><input id="pregunta6" name="pregunta6" class="text-bold form-control" value="Califique del 1 al 7 siendo 1 malo y 7 excelente: El nivel en que se adecuan los productos del banco a sus necesidades" readonly/></div>
                                        <div class="col-xs-2">
                                        ...
                                        <div class="col-xs-8">
                                            <input id="respuesta6_1" name="respuesta6_1" type="text" class="form-control">
                                        </div>
                                        <!---------------------------------------------------------PREGUNTA 7---------------------------------------------------->
                                        <div class="col-xs-12"><label>PILAR - PROCESOS / ATRIBUTO - Agilidad</label></div>
                                        <div class="col-xs-10"><input id="pregunta7" name="pregunta7" class="text-bold form-control" value="Califique del 1 al 7 siendo 1 malo y 7 excelente: La agilidad demostrada por la persona que atendió su requerimiento" readonly/></div>
                                        <div class="col-xs-2">
                                        ...
                                        <div class="col-xs-8">
                                            <input id="respuesta7_1" name="respuesta7_1" type="text" class="form-control">
                                        </div>
                                        <!---------------------------------------------------------PREGUNTA 8---------------------------------------------------->
                                        <div class="col-xs-12"><label>PILAR - DIGITAL / ATRIBUTO - Accesibilidad (Empoderamiento al cliente)</label></div>
                                        <div class="col-xs-10"><input id="pregunta8" name="pregunta8" class="text-bold form-control" value="Califique del 1 al 7 siendo 1 malo y 7 excelente: La facilidad para acceder a los servicios o productos del banco a través de agencias o canales electrónicos" readonly/></div>
                                        <div class="col-xs-2">
                                        ...
                                        <div class="col-xs-8">
                                            <input id="respuesta8_1" name="respuesta8_1" type="text" class="form-control">
                                        </div>
                                        <!---------------------------------------------------------PREGUNTA 9---------------------------------------------------->
                                        ...
                                        <div class="col-xs-8">
                                            <input id="respuesta9_1" name="respuesta9_1" type="text" class="form-control">
                                        </div>
                                        <!---------------------------------------------------------PREGUNTA 10---------------------------------------------------->
                                        ...
                                        <div class="col-xs-8">
                                            <input id="respuesta10_1" name="respuesta10_1" type="text" class="form-control">
                                        </div>
                                        <!---------------------------------------------------------PREGUNTA 11---------------------------------------------------->
                                        ...
                                        <div class="col-xs-8">
                                            <input id="respuesta11_1" name="respuesta11_1" type="text" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script src="scripts/bancoBGREncuesta.js" type="text/javascript"></script>
