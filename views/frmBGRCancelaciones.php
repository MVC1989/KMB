                        ...
                        <form name="formulario" id="formulario" method="POST" class="">
                            ...
                            <div id="pnlEncuesta" class="col-xs-12 btn">
                                <div class="box box-widget bg-gray">
                                    <div class="box-body">
                                        <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                        <div class="col-xs-8"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="¿Me podría comentar el motivo por el cual no pudo hacer efectiva la cita programada?" readonly/></div>
                                        <div class="col-xs-4">
                                            <select id="respuesta1" name="respuesta1" class="form-control">
                                                <option value=""></option>
                                                <option>Si asistió</option>
                                                <option>Motivos de trabajo</option>
                                                <option>Asistió antes</option>
                                                <option>Motivos personales</option>
                                                <option>Recibió atención por otro canal</option>
                                                <option>Tuvo que viajar</option>
                                                ...
                                                <option>Tomó turno normal</option>
                                                <option>Tenía otra cita</option>
                                                <option>Por motivos de Salud</option>
                                                ...
                                                <option>Banco canceló la cita</option>
                                                <option>No tiene registro cita</option>
...
<script src="scripts/bancoBGRCitasCanceladas.js" type="text/javascript"></script>
