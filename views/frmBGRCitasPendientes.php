                        ...
                        <form name="formulario" id="formulario" method="POST" class="">
                            ...
                            <div id="pnlEncuesta" class="col-xs-12 btn">
                                <div class="box box-widget bg-gray">
                                    <div class="box-body">
                                        <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                        <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="Asistará a la cita agendada?" readonly/></div>
                                        <div class="col-xs-3">  
                                            <select id="respuesta1" name="respuesta1" class="form-control">
                                                <option value=""></option>
                                                <option >SI</option>
                                                <option >SI, CONTESTARÁ LA LLAMADA AL ASESOR BGR</option>
                                                <option >NO</option>
                                                <option >TAL VEZ</option>
                                            </select>
                                        </div>
                                        <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                        <div class="col-xs-9"><input id="pregunta2" name="pregunta2" class="text-bold form-control" value="Podría indicarnos el motivo de su respuesta?" readonly/></div>
                                        <div class="col-xs-3">
                                            <select id="respuesta2" name="respuesta2" class="form-control">
                                                <option value=""></option>
                                                <option>Resolvió su necesidad previamente</option>
                                                <option>Recibió atención por otro canal</option>
                                                <option>Por trabajo</option>
                                                <option>Cambió de hora</option>
                                                <option>Porque tuvo que viajar</option>
                                                <option>Cita médica - por salud</option>
                                                <option>Fue a otra agencia</option>
                                                <option>No se atiende ese trámite</option>
                                                <option>Motivos personales</option>
                                                <option>Motivos Laborales</option>
                                                <option>Restricción vehicular</option>
                                                <option>Si asistirá</option>
                                                <option>Por una emergencia</option>
                                                <option>Emergencia</option>
                                                <option>Asesor BGR llamará (Si contestará)</option>
                                                <option>Asesor BGR llamará (No contestará)</option>
                                                <option>Asesor BGR no sé comunicó con el cliente</option>
                                                <option>Seleccionó agencia incorrecta</option>
                                                <option>No fue notificado que no habría atención en feriado</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
...
<script src="scripts/bancoBGRCitasPendientes.js" type="text/javascript"></script>
