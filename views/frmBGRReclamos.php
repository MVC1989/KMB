                            ...
                            <div id="pnlEncuesta1" class="col-xs-12 btn">
                                <div class="box box-widget bg-gray">
                                    <div class="box-body">
                                        <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->                                        
                                        <div class="col-xs-10">
                                            <input id="pregunta1" name="pregunta1" class="text-bold form-control" readonly value="1. Su grado de satisfacción con el servicio recibido en BGR" />
                                        </div>
                                        <div class="col-xs-2">
                                        ...
                                        <div class="col-xs-4">
                                            <input id="pregunta2" name="pregunta2" class="text-bold form-control" readonly value="1.1.- Cuál es el motivo de su calificación?" />
                                        </div>
                                        <div class="col-xs-8">
                                            <input id="respuesta2" name="respuesta2" type="text" class="form-control">                                           
                                        </div>
                                        <div class="col-xs-10">
                                            <input id="pregunta3" name="pregunta3" class="text-bold form-control" readonly value="2. La persona que atendió su reclamo entendió su necesidad?" />
                                        </div>
                                        <div class="col-xs-2">
                                        ...
                                        <div class="col-xs-4">
                                            <input id="pregunta4" name="pregunta4" class="text-bold form-control" readonly value="2.1. ¿Cuál es el motivo de su calificación?" />
                                        </div>
                                        <div class="col-xs-8">
                                            <input id="respuesta4" name="respuesta4" type="text" class="form-control">
                                        </div>
                                        <div class="col-xs-10">
                                            <input id="pregunta5" name="pregunta5" class="text-bold form-control" readonly value="3. ¿El servicio que recibió de la persona que le atendió fue el esperado?" />
                                        </div>
                                        <div class="col-xs-2">
                                        ...
                                        <div class="col-xs-4">
                                            <input id="pregunta6" name="pregunta6" class="text-bold form-control" readonly value="3.1.  ¿Cuál es el motivo de su calificación?" />
                                        </div>
                                        <div class="col-xs-8">
                                            <input id="respuesta6" name="respuesta6" type="text" class="form-control">
                                        </div>
                                        <div class="col-xs-10">
                                            <input id="pregunta7" name="pregunta7" class="text-bold form-control" readonly value="4. Recibió un trato personalizado por parte de la persona que le atendió en su reclamo" />
                                        </div>
                                        <div class="col-xs-2">
                                        ...
                                        <div class="col-xs-4">
                                            <input id="pregunta8" name="pregunta8" class="text-bold form-control" readonly value="4.1. ¿Cuál es el motivo de su calificación?" />
                                        </div>
                                        <div class="col-xs-8">
                                            <input id="respuesta8" name="respuesta8" type="text" class="form-control">
                                        </div>
                                        <div class="col-xs-10">
                                            <input id="pregunta9" name="pregunta9" class="text-bold form-control" readonly value="5. Que tan fácil o sencillo es para usted gestionar su reclamo con BGR" />
                                        </div>
                                        <div class="col-xs-2">
                                        ...
                                        <div class="col-xs-4">
                                            <input id="pregunta10" name="pregunta10" class="text-bold form-control" readonly value="5.1. ¿Cuál es el motivo de su calificación?" />
                                        </div>
                                        <div class="col-xs-8">
                                            <input id="respuesta10" name="respuesta10" type="text" class="form-control">
                                        </div>
                                        <div class="col-xs-10">
                                            <input id="pregunta11" name="pregunta11" class="text-bold form-control" readonly value="6. En escala de 0 a 10 ¿en qué grado recomendaría BGR a un familiar, amigo o colega de trabajo?" />
                                        </div>
                                        <div class="col-xs-2">
                                        ...
                                        <div class="col-xs-4">
                                            <input id="pregunta12" name="pregunta12" class="text-bold form-control" readonly value="6.1 Cual es el motivo de su calificación?" />
                                        </div>
                                        <div class="col-xs-8">
                                            <input id="respuesta12" name="respuesta12" type="text" class="form-control">                                           
                                        </div>
                                        <div class="col-xs-10"><input id="pregunta13" name="pregunta13" class="text-bold form-control" value="7. Si su experiencia con BGR se mantiene igual a la que ha tenido hasta ahora, consideraría seguir con nosotros, por cuánto tiempo más" readonly/></div>
                                        <div class="col-xs-2">
                                        ...
                                        <div class="col-xs-4">
                                            <input id="pregunta14" name="pregunta14" class="text-bold form-control" readonly value="7.1. Cual es el motivo de su calificación?" />
                                        </div>
                                        <div class="col-xs-8">
                                            <input id="respuesta14" name="respuesta14" type="text" class="form-control" maxlength="500">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script src="scripts/bancoBGRReclamos.js" type="text/javascript"></script>
