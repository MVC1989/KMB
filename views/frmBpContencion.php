                            ...
                            <div id="pnlEncuesta" class="col-xs-12 btn">
                                <div class="box box-widget bg-gray">
                                    <div class="box-body col-xs-12 btn">
                                        ...
                                        <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                        <div class="col-xs-9"><input id="pregunta2" name="pregunta2" class="text-bold form-control" readonly value="1.1 Seleccione una aternativa de pago"/></div>
                                        <div class="col-xs-3">
                                            <select id="respuesta2" name="respuesta2" class="form-control">
                                            </select> 
                                        </div>
                                        <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                        <div class="col-xs-9"><input id="pregunta3" name="pregunta3" class="text-bold form-control" readonly value="1.2 ¿Por favor me confirma en qué fecha va a realizar su pago, tenga en cuenta que su fecha máxima es (ver base)?"/></div>
                                        <div class="col-xs-3">
                                            <input type="date" id="respuesta3" name="respuesta3" class="text-bold form-control" />
                                        </div>
                                        <!---------------------------------------------------------PREGUNTA 4---------------------------------------------------->
                                        <div class="col-xs-9"><input id="pregunta4" name="pregunta4" class="text-bold form-control" readonly value="1.3 ¿Porque medio va realizar su pago?"/></div>
                                        <div class="col-xs-3">
...
<script src="scripts/bpContencion.js" type="text/javascript"></script>
