            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="text-bold">Campaña BP Diferidos de Pagos</h4> </div>
                    ...
                    <div class="panel-body" id="formularioRegistros">
                        <form name="formulario" id="formulario" method="POST" class="">
                            ...
                            <div class="box-body col-xs-12 btn">
                                <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="¿Está usted de acuerdo en que realicemos el diferimiento del pago en su tarjeta?" readonly/></div>
                                <div class="col-xs-3">
                                    <select id="respuesta1" name="respuesta1" class="form-control">
                                        <option value=""></option>
                                        <option >SI</option>
                                        <option >NO</option>
                                        <option >PAGUE YA</option>
                                    </select>
                                </div>
                                <div class="col-xs-3"><input id="pregunta2" name="pregunta2" class="text-bold form-control" value="Fecha estimada de pago:" readonly/></div>
                                <div class="col-xs-2">
                                    <input id="respuesta2" name="respuesta2" type="date" class="form-control">
                                </div>
                                <div class="col-xs-5"><input id="pregunta3" name="pregunta3" class="text-bold form-control" value="Por favor confírmeme, su tarjeta es Visa o Mastercard" readonly/></div>
                                <div class="col-xs-2">
                                    <select id="respuesta3" name="respuesta3" class="form-control">
                                        <option value=""></option>
                                        <option >Visa</option>
                                        <option >Mastercard</option>
                                        <option >No coincide</option>
                                        <option >No proporciona información</option>
                                        <option >No aplica</option>
                                    </select>
                                </div>
                                <div class="col-xs-9"><input id="pregunta4" name="pregunta4" class="text-bold form-control" value="En la escala del 1 al 10, ¿Qué tan satisfecho está con los servicios de su tarjeta de crédito?" readonly/></div>
                                <div class="col-xs-3">
                                ...
                                <div class="col-xs-6"><input id="pregunta5" name="pregunta5" class="text-bold form-control" value="Comentarios del cliente (opcional)" readonly/></div>
                                <div class="col-xs-6">
...
<script src="scripts/bpDiferidoDePagos.js" type="text/javascript"></script>
