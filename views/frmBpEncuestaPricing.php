                            ...
                            <div id="pnlEncuesta2" class="col-xs-12 btn">
                                <div class="box box-widget bg-gray">
                                    <div class="box-body col-xs-12 btn">
                                        <div class="col-xs-3"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="Número de cédula:" readonly/></div>
                                        <div class="col-xs-3">
                                            <input onkeypress="return onlyNumbers(event)" id="respuesta1" name="respuesta1" type="text" class="form-control">
                                        </div>
                                        <div class="col-xs-3"><input id="pregunta2" name="pregunta2" class="text-bold form-control" value="Nombres Completos:" readonly/></div>
                                        <div class="col-xs-3">
                                            <input id="respuesta2" name="respuesta2" type="text" class="form-control">
                                        </div>
                                        <div class="col-xs-3"><input id="pregunta3" name="pregunta3" class="text-bold form-control" value="Correo electrónico:" readonly/></div>
                                        <div class="col-xs-3">
                                            <input pattern="[a-zA-Z0-9_-]+([.][a-zA-Z0-9_-]+)*@[a-zA-Z0-9_-]+([.][a-zA-Z0-9_-]+)*[.][a-zA-Z]{1,5}" id="respuesta3" name="respuesta3" type="text" class="form-control">
                                        </div>
                                        <div class="col-xs-3"><input id="pregunta4" name="pregunta4" class="text-bold form-control" value="Número de contacto:" readonly/></div>
                                        <div class="col-xs-3">
                                            <input onkeypress="return onlyNumbers(event)" pattern="^0[2-9](\d{7,8})$" id="respuesta4" name="respuesta4" type="text" class="form-control">
                                        </div>
                                        <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                        <!--<div class="col-xs-6"><textarea id="pregunta1" name="pregunta1" class="text-bold form-control" readonly>1. Cuénteme, ¿a qué se dedicas?</textarea></div>
                                        <div class="col-xs-6">
                                            <input id="respuesta1" name="respuesta1" type="text" value="" class="form-control" readonly>
                                        </div>-->
                                        <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                        <!--<div class="col-xs-12"><textarea id="pregunta2" name="pregunta2" class="text-bold form-control" readonly>2. ¿Qué dispositivo electrónico utilizas con mayor frecuencia en su día a día?</textarea></div>
                                        <div class="col-xs-2">
                                            <div class="input-group">
                                                <span class="input-group-addon">
                                                    <input id="chk_ENC2" name="chk_ENC2" value="chk_ENC2" type="checkbox">
                                                </span>
                                                <input id="respuesta2" name="respuesta2" type="text" value="Celular" class="form-control" readonly>
                                            </div>
                                        </div>
                                        <div class="col-xs-3">
                                            <div class="input-group">
                                                ...
                                                <input id="respuesta3" name="respuesta3" type="text" value="Computadora portátil" class="form-control" readonly>
                                            </div>
                                        </div>
                                        <div class="col-xs-3">
                                            <div class="input-group">
                                                ...
                                                <input id="respuesta4" name="respuesta4" type="text" value="Computadora de escritorio" class="form-control" readonly>
                                            </div>
                                        </div>
                                        <div class="col-xs-2">
                                            <div class="input-group">
                                                ...
                                                <input id="respuesta5" name="respuesta5" type="text" value="Tablet" class="form-control" readonly>
                                            </div>
                                        </div>
                                        <div class="col-xs-2">
                                            <div class="input-group">
                                                ...
                                                <input id="respuesta6" name="respuesta6" type="text" value="No utilizo ninguno" class="form-control" readonly>
                                            </div>
                                        </div> -->
                                        <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                        <!--<div class="col-xs-10"><textarea id="pregunta7" name="pregunta7" class="text-bold form-control" readonly>3. ¿Qué medios conoces para hacer una referencia bancaria o certificado bancario?</textarea></div>
                                        <div class="col-xs-2">
                                            <select id="respuesta7" name="respuesta7" class="form-control">
                                                <option value=""></option>
                                                <option >Ventanilla</option>
                                                <option >Agencia</option>
                                                <option >Ventanilla y agencia</option>
                                                <option >Web</option>
                                                <option >Web y agencia</option>
                                                <option >Balcón de servicios</option>
                                                <option >Call center</option>
                                            </select> 
                                        </div> -->

                                        <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                        <!--<div class="col-xs-6" id="divPregunta8"><input id="pregunta8" name="pregunta8" class="text-bold form-control" value="" readonly/></div>
                                        <div class="col-xs-6" id="divRespuesta8">
                                            <input id="respuesta8" name="respuesta8" type="text" class="form-control">
                                        </div>-->
                                        <!---------------------------------------------------------PREGUNTA 4---------------------------------------------------->
                                        <!--<div class="col-xs-12"><input id="pregunta9" name="pregunta9" class="text-bold form-control" value="" readonly/></div>
                                        <div class="col-xs-12">
                                            <input id="respuesta9" name="respuesta9" type="text" class="form-control">
                                        </div>-->
                                        <!---------------------------------------------------------PREGUNTA 5---------------------------------------------------->           
                                        <!--<div class="col-xs-6"><input id="pregunta10" name="pregunta10" class="text-bold form-control" readonly value="¿Por qué?"/></div>
                                        <div class="col-xs-6">
...
<script src="scripts/bpEncuestaPricing.js" type="text/javascript"></script>
