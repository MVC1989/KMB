                    ...
                    <div class="panel-body" id="formularioRegistros">
                        <form name="formulario" id="formulario" method="POST" class="">
                            ...
                            <div class="col-xs-12 btn bg-gray-light">
                                ...
                                <div class="col-xs-4"> <b>TIPO IDENTIFICACION </b>
                            ...
                            <div id="pnlEncuesta2" class="col-xs-12 btn">
                                <div class="box box-widget bg-gray">
                                    <div class="box-body col-xs-12 btn">
                                        <div class="col-xs-3"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="Tiene acceso a la WEB:" readonly/></div>
                                        <div class="col-xs-3">
...
<script src="scripts/bpEncuestaGenerica.js" type="text/javascript"></script>
