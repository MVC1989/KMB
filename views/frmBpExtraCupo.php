                        ...
                        <form name="formulario" id="formulario" method="POST" class="">
                            ...
                            <div id="pnlEncuesta" class="col-xs-12 btn">
                                <div class="box box-widget bg-gray">
                                    <div class="box-body">
                                        <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                        <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="1. ¿Desea continuar con esta conversación y conocer sobre este beneficio?" readonly/></div>
                                        <div class="col-xs-3">  
                                        ...
                                        <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                        <div class="col-xs-6"><input id="pregunta2" name="pregunta2" class="text-bold form-control" value="2. ¿Por favor me puede confirmar en que unidad educativa haría uso de este beneficio?" readonly/></div>
                                        <div class="col-xs-6">
...
<script src="scripts/bpExtraCUpo.js" type="text/javascript"></script>
