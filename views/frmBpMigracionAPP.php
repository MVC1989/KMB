                            ...
                            <div id="pnlEncuesta2" class="col-xs-12 btn">
                                <div class="box box-widget bg-gray">
                                    <div class="box-body col-xs-12 btn">
                                        <div class="col-xs-9"><input id="pregunta1" name="pregunta1" class="text-bold form-control" value="¿Ingresó la nueva Banca Móvil?" readonly/></div>
                                        <div class="col-xs-3">
                                            <select id="respuesta1" name="respuesta1" class="form-control">
                                                <option value=""></option>
                                                <option >SI</option>
                                                <option >NO</option>
                                                <option >Tengo la versión vieja</option>
                                            </select>
                                        </div>
                                        <div class="col-xs-9"><input id="pregunta2" name="pregunta2" class="text-bold form-control" value="¿Queremos confirmar si puede acceder por medio de PIN, huella o reconocimiento facial?" readonly/></div>
                                        <div class="col-xs-3">
...
<script src="scripts/bpMigracionAPP.js" type="text/javascript"></script>
