            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="text-bold">Campaña Claro Ventas</h4> </div>
                    ...
                    <div class="panel-body" id="formularioRegistros">
                        <form name="formulario" id="formulario" method="POST" class="">
                            ...
                            <div id="pnlVentas" class="col-xs-12 btn">
                                <div class="box box-widget bg-gray">
                                    <div class="box-body">
                                        ...
                                        <div class="col-xs-4"> <b>NOMBRES </b>
                                        ...
                                        <div class="col-xs-4"> <b>REGION PROVINCIA </b>
                                            <input type="text" class="form-control input-sm" id="REGION_PROVINCIA" name="REGION_PROVINCIA" />
                                        </div>
                                        <div class="col-xs-2"> <b>FECHA NACIMIENTO </b>
                                            <input type="date" class="form-control input-sm" id="FECHA_NACIMIENTO" name="FECHA_NACIMIENTO" />
                                        </div>
                                        <div class="col-xs-2"> <b>TIPO DEBITO </b>
                                        ...
                                        <div class="col-xs-2"> <b>NUMERO DEBITO </b>
                                            <input type="text" onkeypress="return onlyNumbers(event)" class="form-control input-sm" id="NUMERO_DEBITO" name="NUMERO_DEBITO" />
                                        </div>
                                        <div class="col-xs-2"> <b>CVV </b>
                                            <input type="text" onkeypress="return onlyNumbers(event)" maxlength="3" class="form-control input-sm" id="CVV" name="CVV" />
                                        </div>
                                        <div class="col-xs-2"> <b>OPERADORA ACTUAL </b>
                                            <select class="form-control input-sm" id="OPERADORA_ACTUAL" name="OPERADORA_ACTUAL">
                                                <option></option>
                                                <option>CLARO</option>
                                                <option>CNT</option>
                                        ...
                                        <div class="col-xs-2"> <b>TELÉFONO DE REFERENCIA </b>
                                            <input type="text" pattern="^09(\d{8})$" onkeypress="return onlyNumbers(event)" class="form-control input-sm" id="NUMERO_REFERENCIA" name="NUMERO_REFERENCIA" />
                                        </div>
                                        <div class="col-xs-2"> <b>CODIGO DEL PLAN </b>
                                            <input type="text" class="form-control input-sm" id="CODIGO_PLAN" name="CODIGO_PLAN" />
                                        </div>
                                        <div class="col-xs-6"> <b>DIRECCION </b>
...
<script src="scripts/claroAgendamiento.js" type="text/javascript"></script>
