                                ...
                                <div class="box box-widget bg-gray">
                                    <div class="box-body">
                                        ...
                                        <div class="col-xs-2"> <b>TELÉFONO DE REFERENCIA </b>
                                            <input type="text" onkeypress="return onlyNumbers(event)" class="form-control input-sm" id="NUMERO_REFERENCIA" name="NUMERO_REFERENCIA" />
                                        </div>
...
<script src="scripts/claroCampaign.js" type="text/javascript"></script>
