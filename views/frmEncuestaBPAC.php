                    ...
                    <div class="panel-body" id="formularioRegistros">
                        <form name="formulario" id="formulario" method="POST" class="">
                            ...
                            <div class="col-xs-12 btn bg-gray-light">
                                ...
                                <div class="col-xs-4"> <b>Nombre Punto de Venta </b>
                            ...
                            <div id="pnlEncuesta1" class="col-xs-12 btn">
                                <div class="box box-widget bg-gray">
                                    <div class="box-body col-xs-12 btn">
                                        <!---------------------------------------------------------PREGUNTA 1---------------------------------------------------->
                                        <div class="col-xs-10"><textarea id="pregunta1" name="pregunta1" class="text-bold form-control" readonly>1.	¿Quién le comunicó que su crédito automotriz fue aprobado por Banco Pichincha?</textarea></div>
                                        <div class="col-xs-2">
                                            <select id="respuesta1" name="respuesta1" class="form-control">
                                                <option value=""></option>
                                                <option >CONCESIONARIO</option>
                                                <option >EJECUTIVO DEL BANCO</option>
                                                <option >NINGUNO</option>
                                                <!--<option value="NO PROPORCIONA INFORMACION">NO PROPORCIONA INFORMACION</option>-->
                                            </select>
                                        </div>
                                        <!---------------------------------------------------------PREGUNTA 2---------------------------------------------------->
                                        <div class="col-xs-8"><textarea id="pregunta2" name="pregunta2" class="text-bold form-control" readonly>2.	Me puede indicar los motivos por los cuáles no se ha decidido por el financiamiento con Banco Pichincha?</textarea></div>
                                        <div class="col-xs-4">
                                            <select id="respuesta2" name="respuesta2" class="form-control">
                                                <option value=""></option>
                                                <option >Adquirió el vehículo con otra institución financiera</option>
                                                <option >Compró de contado</option>
                                                <option >Desistido/ No desea comprar el vehículo</option>
                                                <option >Por completar el valor de la entrada</option>
                                                <option >En espera de la venta de vehículo usado</option>
                                                <option >Indeciso por marca o modelo de vehículo</option>
                                                <option >Indeciso por otros motivos diferentes a marca o modelo</option>
                                            </select>
                                        </div>
                                        <!---------------------------------------------------------PREGUNTA 3---------------------------------------------------->
                                        <div class="col-xs-8"><input id="pregunta3" name="pregunta3" class="text-bold form-control" value="Cuál?" readonly/></div>
                                        <div class="col-xs-4">
                                            <input id="respuesta3" name="respuesta3" type="text" class="form-control">
                                        </div>
                                        <!---------------------------------------------------------PREGUNTA 4---------------------------------------------------->
                                        <div class="col-xs-8"><input id="pregunta4" name="pregunta4" class="text-bold form-control" value="¿Cuándo cree usted que pueda completar el valor de la entrada?" readonly/></div>
                                        <div class="col-xs-4">
                                            <input id="respuesta4" name="respuesta4" type="date" class="form-control">
                                        </div>
                                        <!---------------------------------------------------------PREGUNTA 5---------------------------------------------------->
                                        <div class="col-xs-8"><input id="pregunta5" name="pregunta5" class="text-bold form-control" readonly value="¿Tiene una fecha estimada en la que realizará la venta de su vehículo?"/></div>
                                        <div class="col-xs-4">
                                            <input id="respuesta5" name="respuesta5" type="date" class="form-control">
                                        </div>
                                        <!---------------------------------------------------------PREGUNTA 6---------------------------------------------------->
                                        <div class="col-xs-8"><input id="pregunta6" name="pregunta6" class="text-bold form-control" value="¿Qué día y a qué hora nos podemos volver a contactar?" readonly/></div>
                                        <div class="col-xs-4">
                                            <input id="respuesta6" name="respuesta6" type="datetime" class="form-control">
                                        </div>
                                        <!---------------------------------------------------------PREGUNTA 7---------------------------------------------------->
                                        <div class="col-xs-8"><input id="pregunta7" name="pregunta7" class="text-bold form-control" value="¿Qué marcas le interesan? " readonly/></div>
                                        <div class="col-xs-4">
                                            <input id="respuesta7" name="respuesta7" type="text" class="form-control">
                                        </div>
                                        <!---------------------------------------------------------PREGUNTA 8---------------------------------------------------->
                                        <div class="col-xs-8"><input id="pregunta8" name="pregunta8" class="text-bold form-control" value="Motivos" readonly/></div>
                                        <div class="col-xs-4">
                                            <input id="respuesta8" name="respuesta8" type="text" class="form-control">
                                        </div>
                                        <!---------------------------------------------------------PREGUNTA 9---------------------------------------------------->
                                        <div class="col-xs-8"><input id="pregunta9" name="pregunta9" class="text-bold form-control" value="3.	¿Usted está interesado en acceder a esta oferta aprobada?" readonly/></div>
                                        <div class="col-xs-4">
...
<script src="scripts/bpEncuestaBPAC1.js" type="text/javascript"></script>
