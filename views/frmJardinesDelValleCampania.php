                    ...
                    <div class="panel-body" id="formularioRegistros">
                        <form name="formulario" id="formulario" method="POST" class="">
                            ...
                            <div class="box-body col-xs-12">
                                <div class="btn bg-gray-light col-xs-12">
                                    ...
                                    <div class="col-xs-4"> <b>NOMBRE_CLIENTE </b>
                                        <input type="text" class="form-control input-sm" id="NOMBRE_CLIENTE" name="NOMBRE_CLIENTE" readonly/>
                                    </div>
                                    <div class="col-xs-3"> <b>CIUDAD1 </b>
                                        <input type="text" class="form-control input-sm" id="CIUDAD1" name="CIUDAD1" readonly/>
                                    </div>
                                    <div class="col-xs-3"> <b>CIUDAD2 </b>
                                        <input type="text" class="form-control input-sm" id="CIUDAD2" name="CIUDAD2" readonly/>
                                    </div>
                                </div>
                            </div>
                            <div id="pnlEncuesta" class="col-xs-12 btn">
                                <div class="box box-widget bg-gray">
                                    <div class="box-body">
                                        <div class="col-xs-12">
                                            <input id="pregunta1" name="pregunta1" class="text-bold form-control" readonly />
                                        </div>
                                        <div class="col-xs-12">
                                            <input id="pregunta2" name="pregunta2" class="text-bold form-control" readonly value="¿Me ayuda con su número de cedula?" />
                                        </div>
                                        <div class="col-xs-9">
                                            <input id="pregunta3" name="pregunta3" class="text-bold form-control" readonly value="¿Su teléfono celular es el ...?" />
                                        </div>
                                        <div class="col-xs-3">
                                            <div class="col-xs-3">
                                            ...
                                            <div id="textCell" class="col-xs-9">
                                                <input pattern="^09(\d{8})$" onkeypress="return onlyNumbers(event)" type="text" class="form-control input-sm" id="celularTCP" name="celularTCP" />
                                            </div>
                                        </div>
                                        <div class="col-xs-9">
                                            <input id="pregunta4" name="pregunta4" class="text-bold form-control" readonly value="¿Cuenta este número con WhatsApp?" />
                                        </div>
                                        <div class="col-xs-3">
                                            <select class="form-control input-sm" id="TIENE_WHATSAPP" name="TIENE_WHATSAPP">
                                                <option></option>
                                                <option>SI</option>
                                                <option>NO</option>
                                            </select>
                                        ...
                                        <div class="col-xs-9">
                                            <input id="pregunta5" name="pregunta5" class="text-bold form-control" readonly value="¿Su correo es?" />
                                        </div>
                                        <div id="textCell" class="col-xs-3">
                                            <input pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" type="text" class="form-control input-sm" id="CORREO" name="CORREO" />
                                        </div>
                                        <div class="col-xs-9">
                                            <input id="pregunta6" name="pregunta6" class="text-bold form-control" readonly value="¿Tipo de débito?" />
                                        </div>
                                        <div class="col-xs-3">
                                            <select class="form-control input-sm" id="TIPO_DEBITO" name="TIPO_DEBITO">
                                                <option></option>
                                        ...
                                        <div class="col-xs-2">
                                            <b class="text-bold">Número de cuenta o tarjeta </b>
                                            <input id="NUMERO_TC" name="NUMERO_TC" onkeypress="return onlyNumbers(event)" type="text" class="form-control input-sm" />
                                        </div>
                                        <div class="col-xs-2">
                                            <b class="text-bold">Fecha de caducidad </b>
                                            <input id="FECHA_CADUCIDAD" name="FECHA_CADUCIDAD" type="text" class="form-control input-sm" />
                                        </div>
                                        <div class="col-xs-2">
                                            <b class="text-bold">Código de seguridad </b>
                                            <input id="CODIGO_SEGURIDAD" name="CODIGO_SEGURIDAD" onkeypress="return onlyNumbers(event)" type="text" class="form-control input-sm" />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script src="scripts/jardinesDelValleCampania.js" type="text/javascript"></script>
