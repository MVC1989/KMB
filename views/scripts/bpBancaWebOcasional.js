...
function mostrar_uno(Id) {
    $.post("../ajax/bpEncuestaGenerica.php?action=selectById", {Id: Id}, function (datos, estado) {
        ...
        if (datos.CAMPO2 == 'Ocasionales (transaccionalmente inactivos)') {
            $('#pregunta7').hide();
            $('#respuesta7').hide();
        } else {
            $('#pregunta7').show();
...
$("#level2").change(function () {
    ...
    if (level1 !== "" && level2 !== "") {
        id = $.ajax({
            ...
            success: function (r) {
                $('#code').val(r);
                if (r == 1 && $('#CAMPO2').val() == 'Ocasionales (transaccionalmente inactivos)') {
                ...
                } else if (r == 1 && ($('#CAMPO2').val() == 'User Ven 1' || $('#CAMPO2').val() == 'User Ven 2')) {
                    $('#respuesta1').attr('required', true);
                    $('#respuesta1').attr('readonly', false);
                    $('#respuesta2').attr('required', true);
                    $('#respuesta2').attr('readonly', false);
