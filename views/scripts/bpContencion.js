...
$("#level1").change(function () {
    ...
    if (text == "CU5") {
        ...
        $("#respuesta2").append('<option>Acepta refinanciamiento</option>');
        $("#respuesta2").append('<option>Mantiene forma de pago</option>');
        $("#respuesta2").append('<option>No aplica</option>');
        ...
        id = $.ajax({
            ...
            success: function (r) {
                ...
                if (r == 1) {
                    ...
                    $('#respuesta1').attr('readonly', false);
                    $("#respuesta2").append('<option></option>');
                    $("#respuesta2").append('<option>Acepta pago total</option>');
                    $("#respuesta2").append('<option>Acepta pago mínimo</option>');
                    $("#respuesta2").append('<option>Acepta pago mínimo obligatorio</option>');
                    $('#respuesta2').attr('required', true);
                    $('#respuesta2').attr('readonly', false);
