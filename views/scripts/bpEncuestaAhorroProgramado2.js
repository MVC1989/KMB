...
function mostrar_uno(Id) {
    $.post("../ajax/bpEncuestaAhorroProgramado1.php?action=selectById", {Id: Id}, function (datos, estado) {
        ...
        if (camp != "") {
            $.ajax({
                type: "GET",
                url: '../ajax/bpEncuestaAhorroProgramado1.php?action=estatus',
                data: {camp: camp},
                success: function (r) {
                    $('#level1').html(r);
                }
        ...
        if (idC != "") {
            $.ajax({
                type: "GET",
                url: '../ajax/bpEncuestaAhorroProgramado1.php?action=telefonos',
                data: {idC: idC},
                success: function (r) {
                    $('#fonos').html(r);
                }
...
$("#level1").change(function () {
    ...
    if (level1 != "") {
        $.ajax({
            type: "GET",
            url: '../ajax/bpEncuestaAhorroProgramado1.php?action=level2',
...
$('#btnFonos').click(function () {
    ...
    if (phones != "" && estatusTel != "") {
        var IDC = $("#IDC").val();
        $.ajax({
            url: '../ajax/bpEncuestaAhorroProgramado1.php?action=updatePhones',
            method: 'POST',
...
function guardar_datos(e) {
    ...
    $.ajax({
        type: "GET",
        url: '../ajax/bpEncuestaAhorroProgramado1.php?action=validePhone',
