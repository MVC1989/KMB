...
$('#respuesta1').change(function () {
    if ($('#respuesta1').val() == 'CONCESIONARIO' || $('#respuesta1').val() == 'EJECUTIVO DEL BANCO') {
...
$('#respuesta2').change(function () {
    if ($('#respuesta2').val() == 'Adquirió el vehículo con otra institución financiera') {
        ...
        $('#respuesta8').val("");
        $('#respuesta9').val("");
    } else if ($('#respuesta2').val() == 'Compró de contado' || $('#respuesta2').val() == 'Desistido/ No desea comprar el vehículo') {
        $('#respuesta3').attr('required', false);
        $('#respuesta3').attr('readonly', true);
        $('#respuesta4').attr('required', false);
        $('#respuesta4').attr('readonly', true);
        ...
        $('#respuesta8').val("");
        $('#respuesta9').val("");
    } else if ($('#respuesta2').val() == 'Por completar el valor de la entrada') {
        $('#respuesta3').attr('required', false);
        $('#respuesta3').attr('readonly', true);
        ...
        $('#respuesta8').val("");
        $('#respuesta9').val("");
    } else if ($('#respuesta2').val() == 'En espera de la venta de vehículo usado') {
        $('#respuesta3').attr('required', false);
        $('#respuesta3').attr('readonly', true);
        $('#respuesta4').attr('required', false);
        $('#respuesta4').attr('readonly', true);
        ...
        $('#respuesta8').val("");
        $('#respuesta9').val("");
    } else if ($('#respuesta2').val() == 'Indeciso por marca o modelo de vehículo') {
        $('#respuesta3').attr('required', false);
        $('#respuesta3').attr('readonly', true);
        $('#respuesta4').attr('required', false);
        $('#respuesta4').attr('readonly', true);
        ...
        $('#respuesta8').val("");
        $('#respuesta9').val("");
    } else if ($('#respuesta2').val() == 'Indeciso por otros motivos diferentes a marca o modelo') {
        $('#respuesta3').attr('required', false);
        $('#respuesta3').attr('readonly', true);
        $('#respuesta4').attr('required', false);
        $('#respuesta4').attr('readonly', true);
