...
function mostrar_todos() {
    tabla = $('#tblListado').dataTable({
        ...
        "ajax": {
            url: '../ajax/jardinesDelValleC.php?action=selectAllRec',
            type: "get",
            dataType: "json",
            error: function (e) {
...
function mostrar_uno(Id) {
    $.post("../ajax/jardinesDelValleC.php?action=selectByIdRec", {Id: Id}, function (datos, estado) {
...
$('#btnFonos').click(function () {
    ...
    if (phones != "" && estatusTel != "") {
        var IDC = $("#IDC").val();
        $.ajax({
            url: '../ajax/jardinesDelValleC.php?action=updatePhones',
            method: 'POST',
